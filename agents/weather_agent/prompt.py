...
WEATHER_TOOL_DESCRIPTION = """Get current weather and hourly forecast data for a location for the specified date range using Open-Meteo API.

Args:
    location: City name (e.g., "London", "Mysore", "New York")
    start_date: Start date in YYYY-MM-DD format.
    end_date: End date in YYYY-MM-DD format. Ensure that the end date is atmost 10 days from the today's date. We don't have the forecast for more than 10 days.

Returns:
    Formatted weather information including current conditions, hourly forecasts of the temperature, rain and snowfall for the specified date range
"""
